...
def hill_algorithm(game_width, game_height, tile_size):
    ...
    for x in range(game_width/tile_size): #Divide by the width of each tile
...
def world_gen(game_width, game_height, tile_size):
    """
    Generate many circles and raise all the coordinates within the circle by x
    ...
    def iterate(iterations, previous_section):
        for i in range(iterations):
            ...
            for i in range(5):
                moved_coordinate = [center_coordinate[0] + random.randrange(-5, 5),
                ...
                if random.randrange(0, 50) == 0:
                    for coordinate in world_coordinates:
                        ...
                        if (coordinate[0] >= moved_coordinate[0] - radius and #x-
